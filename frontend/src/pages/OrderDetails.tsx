...
import { formatOrderWhen, formatPrice } from "../lib/format";
...
function OrderDetails() {
  ...
  if (error || !order) {
    return (
      <Error message="Order not found." action={{ to: "/orders", label: "Back to orders" }} />
    );
  }
  ...
  return (
    <div className="space-y-8 text-left">
      <Link
        to="/orders"
        className="btn btn-ghost btn-sm gap-2 px-4 text-base-content/70 hover:text-primary"
      >
